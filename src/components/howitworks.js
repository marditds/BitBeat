...
export const HowItWorks = () => {
    return (
        <Container>
            <p style={{ marginTop: "30px", marginBottom: "15px", color: "white", fontFamily: "Epilogue", fontSize: "20pt" }} >
                How
                <Image src={logo} alt="logo" style={{ height: "70px", paddingLeft: "6px", paddingRight: "6px", verticalAlign: "baseline" }} fluid />
                Works
            </p>
            <Accordion defaultActiveKey={['0']} alwaysOpen >
                <Accordion.Item eventKey="0" id="accordion-item">
                    ...
                    <Accordion.Body style={{ fontFamily: "Epilogue" }}>
                        <p style={{ marginBottom: "0", textIndent: "40px", textAlign: "justify" }}> The website will be accessible to everyone. The visitors will have to enter the website’s URL in their browser of choice to have access to the website.
                ...
                <Accordion.Item eventKey="1" id="accordion-item">
                    ...
                    <Accordion.Body style={{ fontFamily: "Epilogue" }}>
                        <p style={{ marginBottom: "0", textIndent: "40px", textAlign: "justify" }}>
                        ...
                        <p style={{ textIndent: "40px", textAlign: "justify" }}>
                            The next steps are up to the user. After the profile has been successfully set up, they are free to browse, purchase audio NFTs, or sell them.</p>
                    </Accordion.Body>
                </Accordion.Item>
            </Accordion>
        </Container>
